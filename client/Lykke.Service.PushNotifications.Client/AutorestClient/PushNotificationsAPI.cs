...
namespace Lykke.Service.PushNotifications.AutorestClient
{
    ...
    public partial class PushNotificationsAPI : ServiceClient<PushNotificationsAPI>, IPushNotificationsAPI
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the PushNotificationsAPI class.
        /// </summary>
        /// <param name='handlers'>
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public PushNotificationsAPI(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        public PushNotificationsAPI(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        public PushNotificationsAPI(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        public PushNotificationsAPI(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        public async Task<HttpOperationResponse<ErrorResponse>> SendDataNotificationToAllDevicesWithHttpMessagesAsync(DataNotificationModel model = default(DataNotificationModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/AppNotifications/SendDataNotificationToAllDevices").ToString();
        ...
        public async Task<HttpOperationResponse<ErrorResponse>> SendTextNotificationWithHttpMessagesAsync(TextNotificationModel model = default(TextNotificationModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/AppNotifications/SendTextNotification").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("POST");
        ...
        public async Task<HttpOperationResponse<ErrorResponse>> SendPushTxDialogWithHttpMessagesAsync(PushTxDialogModel model = default(PushTxDialogModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/AppNotifications/SendPushTxDialog").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("POST");
        ...
        public async Task<HttpOperationResponse<ErrorResponse>> SendAssetsCreditedNotificationWithHttpMessagesAsync(AssetsCreditedModel model = default(AssetsCreditedModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/AppNotifications/SendAssetsCreditedNotification").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("POST");
        ...
        public async Task<HttpOperationResponse<ErrorResponse>> SendRawNotificationWithHttpMessagesAsync(RawNotificationModel model = default(RawNotificationModel), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/AppNotifications/SendRawNotification").ToString();
            // Create HTTP transport objects
            var _httpRequest = new HttpRequestMessage();
            HttpResponseMessage _httpResponse = null;
            _httpRequest.Method = new HttpMethod("POST");
